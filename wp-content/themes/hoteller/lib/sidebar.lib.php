...
function hoteller_register_sidebars() 
{
	...
	if ( function_exists('register_sidebar') )
	    register_sidebar(array('id' => 'single-room-sidebar', 'name' => 'Single Room Sidebar', 'description' => 'The default sidebar for single room page'));
...
add_action( 'widgets_init', 'hoteller_register_sidebars' );
