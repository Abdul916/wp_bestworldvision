...
namespace Nextend\SmartSlider3\Platform\WordPress\Admin\Pro;
    ...
    public function upgrader_pre_download($reply, $package, $upgrader) {
        ...
        switch ($status) {
            ...
            case 'DOMAIN_REGISTER_FAILED':
                $message = 'Smart Slider 3 Pro license is not registered on the current website. Please activate this website by following <a href="https://smartslider.helpscoutdocs.com/article/1718-activation" target="_blank">the license activation documentation</a>.';
                break;
