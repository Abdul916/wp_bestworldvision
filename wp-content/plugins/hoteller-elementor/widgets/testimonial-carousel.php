 ...
 * @since 1.0.0
 */
class Hoteller_Testimonial_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'hoteller-testimonial-carousel';
	}
	...
	public function get_title() {
		return __( 'Testimonial Carousel', 'hoteller-elementor' );
	}
		...
		**/
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#ffffff',
		        'selectors' => [
		            '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .shadow-effect' => 'background: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    'card_border_color',
		    [
		        'label' => __( 'Card Border Color', 'hoteller-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#e7e7e7',
		        'selectors' => [
		            '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .shadow-effect' => 'border-color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .shadow-effect' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .shadow-effect',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .shadow-effect .testimonial-name' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .shadow-effect .testimonial-name',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .shadow-effect .testimonial-info-desc' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .shadow-effect .testimonial-info-desc',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#0077FF',
		        'selectors' => [
		            '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .owl-dots .owl-dot span' => 'background: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#0077FF',
		        'selectors' => [
		            '{{WRAPPER}} .testimonials-carousel-wrapper .owl-carousel .owl-dots .owl-dot.active span' => 'background: {{VALUE}}',
		        ],
		    ]
		);
	...
	protected function render() {
		include(HOTELLER_ELEMENTOR_PATH.'templates/testimonial-carousel/index.php');
	}
