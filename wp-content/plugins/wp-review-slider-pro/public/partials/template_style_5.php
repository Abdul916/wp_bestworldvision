...
<div class="wpproslider_t5_DIV_1a">
	...
	<div class="indrevdiv wpproslider_t5_DIV_3">
		<div class="indrevtxt wpproslider_t5_P_4 wprev_preview_tcolor1_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>">
			<?php echo $rdmorescroll[0]; ?><span class="wprevpro_star_imgs_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $starhtml; ?><?php echo $verifiedstarhtmlarray[0]; ?></span>
			<?php echo $title; ?><?php echo stripslashes($reviewtext); ?><?php echo $verifiedstarhtmlarray[1]; ?>
		<span class="wpproslider_t5_SPAN_6 wprev_preview_tcolor2_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><span class="wprev_showdate_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $datestring; ?></span></span><?php echo $rdmorescroll[1]; ?><?php echo $ownerresponse; ?>
		<?php echo $media; ?>
		</div>
