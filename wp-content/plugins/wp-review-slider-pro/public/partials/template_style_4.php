...
for ($x = 0; $x < count($rowarray); $x++) {
	...
	<div class="<?php echo $tempmasonrydiv; ?> outerrevdiv">
		<div class="indrevdiv wpproslider_t4_DIV_1a<?php if($iswidget){echo "_widget";} ?>  wprev_preview_bg1_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?> wprev_preview_bradius_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>">
			...
			<div class="indrevtxt wpproslider_t4_P_5 wprev_preview_tcolor2_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $rdmorescroll[0]; ?>
				<?php echo $title; ?><?php echo stripslashes($reviewtext); ?><?php echo $verifiedstarhtmlarray[1]; ?><?php echo $rdmorescroll[1]; ?>
				<?php echo $ownerresponse; ?>
			</div>
