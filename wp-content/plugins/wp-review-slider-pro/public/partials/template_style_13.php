...
foreach ( $rowarray[$x] as $review ) 
{
	...
	if($currentform[0]->display_num>0){
		...
		if($userpic==""){
			...
			$userpichtml = $profilelink['start'].'<img loading="lazy" src="'.$userpic.'" alt="'.$altname.' Avatar" class="wpproslider_t13_IMG_2 wprevpro_avatarimg" />'.$profilelink['end'];
			if(isset($template_misc_array['avataropt'])){
				if($template_misc_array['avataropt']=='hide'){
					...
					$userpichtml = $profilelink['start'].'<img loading="lazy" src="'.$tempuserpic.'" alt="'.$altname.' Avatar" class="wpproslider_t13_IMG_2 wprevpro_avatarimg" />'.$profilelink['end'];
		...
		*/
		...
		if($template_misc_array['showstars'] =="yes2"){
			$divclassstarstyle2 = "divclassstarstyle2";
		}
...
<div class="wpproslider_t6_DIV_1a">
	<div class="indrevdiv wpproslider_t13_DIV_2 wprev_preview_bg1_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?> wprev_preview_bradius_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>">
	<div class=" wpproslider_t13_DIV_4">
			<div class="indrevtxt wpproslider_t13_P_4 wprev_preview_tcolor1_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $rdmorescroll[0]; ?>
	...
	<div class="wpproslider_t13_DIV_2_bot">
		...
		<div class="wpproslider_t13_DIV_3">
			<div class="t13displayname wpproslider_t6_STRONG_5 wprev_preview_tcolor2_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $tempreviewername; ?><?php echo $companyhtml;?></div>
			<div class="wpproslider_t13_star_DIV <?php echo $divclassstarstyle2; ?>"><span class="wprevpro_star_imgs_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $starhtml; ?><?php echo $verifiedstarhtmlarray[0]; ?></span></div>
			<div class="wpproslider_t13_SPAN_6 wprev_preview_tcolor2_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><span class="wprev_showdate_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $datestring; ?></span></div>
		</div>
	</div>


	<div class="wpproslider_t13_DIV_3_logo"><?php echo $logo; ?></div>
	</div>
