...
//readmore pop-up setting, basically adding style 6 in hidden div and then using lity to pop it up if set.
...
<div class="wpproslider_t2_DIV_1a">
	...
	<div class="wpproslider_t2_avatar"><?php echo $userpichtml; ?></div>
	<div class="indrevdiv wpproslider_t2_DIV_3">
		<div class="indrevtxt wpproslider_t2_P_4 wprev_preview_tcolor1_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $rdmorescroll[0]; ?>
			...
			<?php echo $rdmorescroll[1]; ?><?php echo $ownerresponse; ?>
		</div>
