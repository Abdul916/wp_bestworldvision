...
class ContainerBuilderTest extends TestCase
{
    ...
    public function testGetServiceIds()
    {
        ...
        $this->assertEquals(
            [
                ...
                'foo',
                'bar',
                'AmeliaPsr\Container\ContainerInterface',
    ...
    public function testArgumentsHaveHigherPriorityThanBindings()
    {
        ...
        $this->assertSame(['service_container', 'class.via.bindings', 'class.via.argument', 'foo', 'AmeliaPsr\Container\ContainerInterface', 'Symfony\Component\DependencyInjection\ContainerInterface'], $container->getServiceIds());
