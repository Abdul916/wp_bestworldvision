 ...
 * @property null|string|\AmeliaStripe\Account|\AmeliaStripe\BankAccount|\AmeliaStripe\Card|\AmeliaStripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\AmeliaStripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \AmeliaStripe\Collection<\AmeliaStripe\Account|\AmeliaStripe\BankAccount|\AmeliaStripe\Card|\AmeliaStripe\Source> $sources The customer's payment sources, if any.
 * @property \AmeliaStripe\Collection<\AmeliaStripe\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property \AmeliaStripe\StripeObject $tax
 ...
 * @property \AmeliaStripe\Collection<\AmeliaStripe\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\AmeliaStripe\TestHelpers\TestClock $test_clock ID of the test clock this customer belongs to.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Customer the updated customer
     */
     ...
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\PaymentMethod> list of PaymentMethods
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Customer the retrieved customer
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\SearchResult<Customer> the customer search results
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\CashBalance
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\CustomerBalanceTransaction
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\CustomerCashBalanceTransaction> the list of customer cash balance transactions
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\BankAccount|\AmeliaStripe\Card|\AmeliaStripe\Source> the list of payment sources (BankAccount, Card or Source)
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\BankAccount|\AmeliaStripe\Card|\AmeliaStripe\Source
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\TaxId> the list of tax ids
     */
