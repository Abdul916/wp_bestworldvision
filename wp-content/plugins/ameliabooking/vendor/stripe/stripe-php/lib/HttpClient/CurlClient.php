...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \AmeliaStripe\Util\RandomGenerator */
     ...
     * @param null|\AmeliaStripe\Util\RandomGenerator $randomGenerator
     */
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\AmeliaStripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
