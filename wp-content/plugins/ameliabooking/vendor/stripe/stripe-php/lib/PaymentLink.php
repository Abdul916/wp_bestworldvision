 ...
 * @property \AmeliaStripe\StripeObject $after_completion
 ...
 * @property null|\AmeliaStripe\StripeObject $consent_collection When set, provides configuration to gather active consent from customers.
 ...
 * @property \AmeliaStripe\Collection<\AmeliaStripe\LineItem> $line_items The line items representing what is being sold.
 ...
 * @property null|\AmeliaStripe\StripeObject $payment_intent_data Indicates the parameters to be passed to PaymentIntent creation during checkout.
 ...
 * @property null|\AmeliaStripe\StripeObject $shipping_address_collection Configuration for collecting the customer's shipping address.
 * @property \AmeliaStripe\StripeObject[] $shipping_options The shipping rate options applied to the session.
 ...
 * @property null|\AmeliaStripe\StripeObject $subscription_data When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use <code>subscription_data</code>.
 * @property \AmeliaStripe\StripeObject $tax_id_collection
 * @property null|\AmeliaStripe\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to.
