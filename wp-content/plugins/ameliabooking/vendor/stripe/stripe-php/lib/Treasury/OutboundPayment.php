 ...
 * @property null|\AmeliaStripe\StripeObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\AmeliaStripe\StripeObject $end_user_details Details about the end user.
 ...
 * @property null|\AmeliaStripe\StripeObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property string|\AmeliaStripe\Treasury\Transaction $transaction The Transaction associated with this object.
 */
class OutboundPayment extends \AmeliaStripe\ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Treasury\OutboundPayment the canceled outbound payment
     */
