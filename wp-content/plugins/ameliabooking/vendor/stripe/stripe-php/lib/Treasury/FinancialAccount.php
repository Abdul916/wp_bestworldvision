 ...
 * @property \AmeliaStripe\StripeObject $balance Balance information for the FinancialAccount
 ...
 * @property \AmeliaStripe\Treasury\FinancialAccountFeatures $features Encodes whether a FinancialAccount has access to a particular Feature, with a <code>status</code> enum and associated <code>status_details</code>. Stripe or the platform can control Features via the requested field.
 * @property \AmeliaStripe\StripeObject[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|\AmeliaStripe\StripeObject $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property \AmeliaStripe\StripeObject $status_details
 ...
 */
class FinancialAccount extends \AmeliaStripe\ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Treasury\FinancialAccount the retrieved financial account
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Treasury\FinancialAccount the updated financial account
     */
