 ...
 * @property null|string|\AmeliaStripe\Refund $destination_payment_refund Linked payment refund for the transfer reversal.
 ...
 * @property null|string|\AmeliaStripe\Refund $source_refund ID of the refund responsible for the transfer reversal.
 * @property string|\AmeliaStripe\Transfer $transfer ID of the transfer that was reversed.
 */
