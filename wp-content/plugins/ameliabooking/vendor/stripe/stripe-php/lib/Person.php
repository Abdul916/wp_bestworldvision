 ...
 * @property null|\AmeliaStripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\AmeliaStripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \AmeliaStripe\StripeObject $dob
 ...
 * @property null|\AmeliaStripe\StripeObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \AmeliaStripe\StripeObject $registered_address
 * @property \AmeliaStripe\StripeObject $relationship
 * @property null|\AmeliaStripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \AmeliaStripe\StripeObject $verification
 */
