 ...
 * @property null|string|\AmeliaStripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\AmeliaStripe\Customer $customer The ID of the customer that the bank account is associated with.
