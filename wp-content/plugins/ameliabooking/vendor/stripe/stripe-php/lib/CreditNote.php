 ...
 * @property string|\AmeliaStripe\Customer $customer ID of the customer.
 * @property null|string|\AmeliaStripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \AmeliaStripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\AmeliaStripe\Invoice $invoice ID of the invoice.
 * @property \AmeliaStripe\Collection<\AmeliaStripe\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|string|\AmeliaStripe\Refund $refund Refund related to this credit note.
 ...
 * @property \AmeliaStripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \AmeliaStripe\CreditNote the previewed credit note
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\CreditNoteLineItem> list of CreditNoteLineItems
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\CreditNote the voided credit note
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\CreditNoteLineItem> the list of credit note line items
     */
