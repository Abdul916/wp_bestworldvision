 ...
 * @property \AmeliaStripe\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\AmeliaStripe\Customer $customer The ID of the customer associated with this discount.
