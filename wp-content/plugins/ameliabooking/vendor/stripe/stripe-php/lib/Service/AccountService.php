...
class AccountService extends \AmeliaStripe\Service\AbstractService
{
     ...
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\Account>
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\Capability>
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\BankAccount|\AmeliaStripe\Card>
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\Person>
     */
