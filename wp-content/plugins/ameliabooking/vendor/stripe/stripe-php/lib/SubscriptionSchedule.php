 ...
 * @property null|string|\AmeliaStripe\StripeObject $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\AmeliaStripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\AmeliaStripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \AmeliaStripe\StripeObject $default_settings
 ...
 * @property \AmeliaStripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\AmeliaStripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\AmeliaStripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \AmeliaStripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\SubscriptionSchedule the released subscription schedule
     */
