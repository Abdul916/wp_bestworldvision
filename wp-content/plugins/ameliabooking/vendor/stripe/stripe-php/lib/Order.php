 ...
 * @property null|string|\AmeliaStripe\StripeObject $application ID of the Connect application that created the Order, if any.
 * @property \AmeliaStripe\StripeObject $automatic_tax
 * @property null|\AmeliaStripe\StripeObject $billing_details Customer billing details associated with the order.
 ...
 * @property null|string|\AmeliaStripe\Customer $customer The customer which this orders belongs to.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|(string|\AmeliaStripe\Discount)[] $discounts The discounts applied to the order. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|string $ip_address A recent IP address of the purchaser used for tax reporting and tax location inference.
 * @property \AmeliaStripe\Collection<\AmeliaStripe\LineItem> $line_items A list of line items the customer is ordering. Each line item includes information about the product, the quantity, and the resulting cost. There is a maximum of 100 line items.
 ...
 * @property \AmeliaStripe\StripeObject $payment
 ...
 * @property null|\AmeliaStripe\StripeObject $shipping_details Customer shipping information associated with the order.
 * @property string $status The overall status of the order.
 * @property \AmeliaStripe\StripeObject $tax_details
...
class Order extends ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Order the canceled order
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Order the reopened order
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Order the submited order
     */
