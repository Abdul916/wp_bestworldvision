 ...
 * @property null|\AmeliaStripe\StripeObject $action The most recent action performed by the reader.
 ...
 * @property null|string|\AmeliaStripe\Terminal\Location $location The location identifier of the reader.
...
class Reader extends \AmeliaStripe\ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Terminal\Reader the canceled reader
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Terminal\Reader the processed reader
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Terminal\Reader the seted reader
     */
