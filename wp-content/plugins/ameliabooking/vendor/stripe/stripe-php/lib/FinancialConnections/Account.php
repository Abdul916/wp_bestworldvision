 ...
 * @property null|\AmeliaStripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\AmeliaStripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\AmeliaStripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\AmeliaStripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\AmeliaStripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 */
class Account extends \AmeliaStripe\ApiResource
{
     ...
     *
     * @return \AmeliaStripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\FinancialConnections\AccountOwner> list of BankConnectionsResourceOwners
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\FinancialConnections\Account the refreshed account
     */
