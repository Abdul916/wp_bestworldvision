...
use AmeliaHttp\Client\Common\Exception\LoopException;
use AmeliaHttp\Client\Exception as HttplugException;
...
final class PluginClient implements HttpClient, HttpAsyncClient
{
    ...
    public function __construct($client, array $plugins = [], array $options = [])
    {
        if ($client instanceof HttpAsyncClient) {
            ...
            throw new \RuntimeException('Client must be an instance of AmeliaHttp\\Client\\HttpClient or AmeliaHttp\\Client\\HttpAsyncClient');
        }
