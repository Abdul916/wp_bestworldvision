...
use AmeliaHttp\Discovery\Exception\ClassInstantiationFailedException;
use AmeliaHttp\Discovery\Exception\DiscoveryFailedException;
use AmeliaHttp\Discovery\Exception\NoCandidateFoundException;
use AmeliaHttp\Discovery\Exception\StrategyUnavailableException;
